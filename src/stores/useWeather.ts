...
const codeDetails: Record<string, WeatherCondition> = {
  clear: {
    codes: [0],
    icon: "clear",
    gradient: "bg-gradient-to-b from-blue-700 to-amber-500 blur-md",
  ...
  "partly cloudy": {
    codes: [2],
    icon: "pcloudy",
    gradient: "bg-gradient-to-b from-sky-700 to-blue-900 blur-md",
    gradientNight: "bg-gradient-to-b from-indigo-900 to-black blur-md",
  ...
  cloudy: {
    codes: [3],
    icon: "cloudy",
    gradient: "bg-gradient-to-b from-slate-500 to-gray-900 blur-md",
